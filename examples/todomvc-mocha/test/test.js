...
describe('TODO MVC App', () => {
    ...
    describe('App tests', () => {
        ...
        const mockLocalStorage = () => {
            const store = {};
            sinon.replace(localStorage, 'getItem', key => store[key]);
            sinon.replace(localStorage, 'setItem', (key, value) => store[key] = value + '');
            sinon.replace(localStorage, 'clear', () => store = {});
        }
        ...
        const initApp = () => {
            mockLocalStorage();
            loadFixtures('specs/fixtures/emptypage.html');
            App.init();
